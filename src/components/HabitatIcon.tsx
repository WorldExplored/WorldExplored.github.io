...
export function HabitatIcon({ kind }: { kind: SectionId }) {
  ...
  return <span className={`habitat-icon icon-${kind}`} aria-hidden="true"><svg viewBox="0 0 64 64" fill="none"><defs>
    ...
    {kind === 'experience' && <><path d="M10 47 17 27h30l7 20-22 9Z" fill={shell} stroke="#43839a"/><path d="M17 28 32 18l15 10-15 8Z" fill={glass} stroke="white"/><path d="M20 31v17m8-20v23m8-23v21m8-18v15" stroke="#1687a7" strokeWidth="2"/><path d="M14 50h36" stroke="#70c838" strokeWidth="4" strokeLinecap="round"/><circle cx="32" cy="18" r="5" fill={gold} stroke="white"/></>}
    ...
    {kind === 'history' && <><path d="M10 49h44v6H10Z" fill={shell} stroke="#4e798b"/><path d="M14 48V31h36v17" fill={shell} stroke="#43839a"/><path d="M11 30 32 17l21 13Z" fill={glass} stroke="white" strokeWidth="2"/><path d="M20 31v17m8-17v17m8-17v17m8-17v17" stroke={gold} strokeWidth="3"/><path d="m25 45 7-8 7 8" stroke="#5acb75" strokeWidth="3" strokeLinecap="round"/></>}
    ...
    {kind === 'arcade' && <><path d="M15 43 19 27h27l6 16-5 12H20Z" fill={shell} stroke="#43839a"/><path d="M22 29h20v13H22Z" fill={glass} stroke="white"/><path d="M24 48V36" stroke="#123a4a" strokeWidth="3"/><circle cx="24" cy="35" r="4" fill={gold} stroke="white"/><ellipse cx="39" cy="46" rx="4" ry="2.5" fill="#8ce552"/><ellipse cx="47" cy="43" rx="3" ry="2" fill={glass}/></>}
