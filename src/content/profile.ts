...
export const profile = {
  ...
  heroContribution: 'I contribute to vLLM: GPU kernels, attention selection, compilation caching, and multimodal serving.',
  showAvailability: true,
  availability: 'Seeking Summer 2027 internships in ML engineering, AI systems, and research engineering.',
  about: 'I usually start by reproducing the failure and tracing which assumption broke. Then I make the smallest change I can defend with tests.',
  ...
  sections: [
    { id: 'work', label: 'Open-source work', title: 'Open-source work', dock: true },
    { id: 'research', label: 'Research', title: 'Research', dock: true },
    { id: 'purdue', label: 'Purdue', title: 'Purdue', dock: true },
    { id: 'about', label: 'About', title: 'How I work', dock: true },
  ...
  ui: {
    ...
    verified: 'Verified', close: 'Back to world', home: 'Return to overview',
