...
export const profile = {
  arcade: {
    ...
    games: {
      ...
      memory: { name: 'Coastal Pairs', genre: 'Memory · find a match', description: 'Match all eight pairs.', instructions: 'Turn over two cards at a time. Match all eight pairs in as few attempts as you can. Use Tab and Enter or tap a card.' },
      pong: { name: 'Pond Pong', genre: 'Pong · first to five', description: 'A paddle, a ball, and one opponent.', instructions: 'Move with Up/Down, W/S, the buttons, or drag on the board. You’re on the left. First to five wins.' },
      blocks: { name: 'Cascade Blocks', genre: 'Falling blocks · clear rows', description: 'Fit the pieces together and keep the stack down.', instructions: 'Left/Right moves, Up rotates, Down lowers, and Space drops. Fill a row to clear it. Use the buttons on a touchscreen.' },
    },
  },
  entry: {
    eyebrow: 'Welcome to my corner of the internet.',
    title: 'Travel back to the future.',
    description: 'Explore my work, look around, or stop by the arcade.',
    loading: 'Starting up…',
    windowTitle: 'Srreyansh’s World',
    sound: 'Music & coastal ambience',
    enter: 'Enter the world',
    hint: 'Drag to explore · Choose a building to step inside',
  },
  soundSettings: {
    label: 'Settings', group: 'World settings', ambience: 'Ambience', volume: 'Ambience volume', credits: 'Sound credits',
  ...
  about: 'I’m a Purdue University Data Science student focused on machine learning engineering. I contribute to vLLM and work with Purdue’s AirLab.',
  ...
  experience: [
    { company: 'AirLab · Purdue University', role: 'Undergraduate member', dates: 'Present', location: 'West Lafayette, Indiana', url: 'https://airlab.cs.purdue.edu/team', details: ['I’m part of AirLab at Purdue, led by Professor Chunyi Peng.'] },
  ],
  research: [
    {
      ...
      description: 'Co-authored a study of help-seeking signals in Ukrainian-language social posts during wartime. The dataset contains 11,677 examples, labeled as help-seeking or non-help-seeking.',
    ...
    },
    {
      ...
      description: 'I studied reinforcement learning for traffic signals using LibSignal simulations, comparing traffic flow, travel time, and computing cost across different road networks.',
  ...
  historyMilestones: [
    { date: 'Current', title: 'AirLab · Purdue University', description: 'Undergraduate member of Professor Chunyi Peng’s AirLab.', href: '#experience' },
    {
      date: 'Current',
  ...
  history: [
    ...
    },
    {
      ...
      school: 'Mission Valley ROP',
      dates: 'September 2023 – May 2025',
      description: 'Organized mock competitions and hands-on projects with sensors, custom RC cars, drones, printed circuit boards, and CAD parts.',
    },
  ],
  sections: [
