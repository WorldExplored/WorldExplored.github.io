...
export const world = {
  ...
  quality: {
    high: { dpr: 1.5, grass: 18000, clouds: 36, bubbles: 5, particles: 80, segments: 48, shadows: true, waterDetail: 1 },
    medium: { dpr: 1.25, grass: 10000, clouds: 24, bubbles: 3, particles: 40, segments: 32, shadows: true, waterDetail: 0.65 },
    low: { dpr: 1, grass: 4500, clouds: 14, bubbles: 2, particles: 18, segments: 24, shadows: false, waterDetail: 0.35 },
  },
